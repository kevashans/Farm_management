...
public class App {
    ...
    public static Farm populate() throws IOException {
        ...
        while (file.hasNext()) {
            ...
            MilkTank t1 = new MilkTank(file.next(),file.nextInt(),file.next());
            MilkTank t2 = new MilkTank(file.next(),file.nextInt(),file.next());
            ...
            MilkingMachine m1 = new MilkingMachine(t1, file.next());
            ...
            MilkingMachine m2 = new MilkingMachine(t2, file.next());
